...
class SearchViewCompatHoneycomb {
    ...
    static class C01081 implements OnQueryTextListener {
        final /* synthetic */ OnQueryTextListenerCompatBridge val$listener;

        C01081(OnQueryTextListenerCompatBridge onQueryTextListenerCompatBridge) {
    ...
    static class C01092 implements OnCloseListener {
        final /* synthetic */ OnCloseListenerCompatBridge val$listener;

        C01092(OnCloseListenerCompatBridge onCloseListenerCompatBridge) {
