...
public class FileSystemUtils {
    ...
    long freeSpaceUnix(String path, boolean kb, boolean posix, long timeout) throws IOException {
        ...
        StringTokenizer tok = new StringTokenizer((String) lines.get(WINDOWS), MinimalPrettyPrinter.DEFAULT_ROOT_VALUE_SEPARATOR);
        if (tok.countTokens() >= 4) {
            ...
            tok = new StringTokenizer((String) lines.get(UNIX), MinimalPrettyPrinter.DEFAULT_ROOT_VALUE_SEPARATOR);
        }
        tok.nextToken();
        tok.nextToken();
