...
public final class cf extends bp {
    ...
    static {
        f619a = new cf("session_start", C1053a.NORMAL);
    }

    public cf(String str, C1053a c1053a) {
        this(str, ed.f792a.m771a(), c1053a);
    }

    private cf(String str, String str2, C1053a c1053a) {
