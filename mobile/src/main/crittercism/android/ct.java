...
import crittercism.android.dx.C1066a;
import java.io.File;
...
public final class ct extends da {
    ...
    public static class C1056a implements cz {
    ...
    public final void m684a(boolean z, int i, JSONObject jSONObject) {
        ...
        if (jSONObject != null) {
            ...
            if (this.f693d != null) {
                C1072h c1072h = new C1072h(this.f693d);
                Context context = this.f691b;
                if (c1072h.f807c) {
                    C1072h.m781b(context);
                } else {
                    File a = C1072h.m780a(context);
                ...
                if (c1072h.f806b) {
                    edit.putBoolean("enabled", c1072h.f805a);
                    edit.putBoolean("kill", c1072h.f807c);
                    edit.putBoolean("persist", c1072h.f806b);
                    edit.putInt("interval", c1072h.f808d);
                } else {
                    edit.clear();
                }
                edit.commit();
