...
import crittercism.android.bg.C1017a;
...
public final class bi extends di implements bt {
    ...
    private JSONObject m504a(JSONArray jSONArray) {
        ...
        try {
            ...
            jSONObject2.put("locale", new C1032k().f548a);
    ...
    private static boolean m505b(JSONArray jSONArray) {
        for (int i = 0; i < jSONArray.length(); i++) {
            ...
            if (optJSONArray != null) {
                try {
                    C1017a k = new bg(optJSONArray).m499k();
                    if (!(k == C1017a.SUCCESS || k == C1017a.INTERRUPTED || k == C1017a.ABORTED)) {
                        return true;
                    }
                } catch (Throwable e) {
                    dx.m752a(e);
