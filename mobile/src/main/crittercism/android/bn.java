...
public final class bn {
    ...
    public static class C1020a extends Exception {
    ...
    public bn(String str) {
        if (str == null) {
            throw new C1020a("Given null appId");
        } else if (!str.matches("[0-9a-fA-F]+")) {
            throw new C1020a("Invalid appId: '" + str + "'. AppId must be hexadecimal characters");
            ...
            if (str2 == null) {
                throw new C1020a("Invalid appId: '" + str + "'. Invalid app locator code");
            }
            ...
            throw new C1020a("Invalid appId: '" + str + "'. AppId must be either 24 or 40 characters");
        }
    }
