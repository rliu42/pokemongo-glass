...
public final class LinkedTreeMap<K, V> extends AbstractMap<K, V> implements Serializable {
    ...
    static class C06931 implements Comparator<Comparable> {
        C06931() {
        }
    ...
    class EntrySet extends AbstractSet<Entry<K, V>> {
        ...
        class C06941 extends LinkedTreeMapIterator<Entry<K, V>> {
            C06941() {
                super(null);
            }
    ...
    class KeySet extends AbstractSet<K> {
        ...
        class C06951 extends LinkedTreeMapIterator<K> {
            C06951() {
                super(null);
            }
