...
public class zzih {
    ...
    static class C05771 implements zza {
        C05771() {
        }
    ...
    class C05782 implements com.google.android.gms.internal.zzm.zza {
        final /* synthetic */ zzc zzJb;
        final /* synthetic */ zzih zzJc;
        final /* synthetic */ String zzyc;

        C05782(zzih com_google_android_gms_internal_zzih, String str, zzc com_google_android_gms_internal_zzih_zzc) {
    ...
    class C05793 extends zzab {
        final /* synthetic */ zzih zzJc;
        final /* synthetic */ Map zzJd;

        C05793(zzih com_google_android_gms_internal_zzih, String str, com.google.android.gms.internal.zzm.zzb com_google_android_gms_internal_zzm_zzb, com.google.android.gms.internal.zzm.zza com_google_android_gms_internal_zzm_zza, Map map) {
            this.zzJc = com_google_android_gms_internal_zzih;
            this.zzJd = map;
    ...
    private static class zzb<T> extends zzk<InputStream> {
        ...
        class C05801 implements com.google.android.gms.internal.zzm.zza {
            final /* synthetic */ com.google.android.gms.internal.zzm.zzb zzJf;
            final /* synthetic */ zza zzJg;

            C05801(com.google.android.gms.internal.zzm.zzb com_google_android_gms_internal_zzm_zzb, zza com_google_android_gms_internal_zzih_zza) {
        ...
        public zzb(String str, zza<T> com_google_android_gms_internal_zzih_zza_T, com.google.android.gms.internal.zzm.zzb<T> com_google_android_gms_internal_zzm_zzb_T) {
            super(0, str, new C05801(com_google_android_gms_internal_zzm_zzb_T, com_google_android_gms_internal_zzih_zza_T));
    ...
    public zziq<String> zza(String str, Map<String, String> map) {
        Object com_google_android_gms_internal_zzih_zzc = new zzc();
        zzIZ.zze(new C05793(this, str, com_google_android_gms_internal_zzih_zzc, new C05782(this, str, com_google_android_gms_internal_zzih_zzc), map));
        return com_google_android_gms_internal_zzih_zzc;
    }
}
