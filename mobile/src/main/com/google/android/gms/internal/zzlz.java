...
public final class zzlz implements zzly {
    ...
    class C06181 extends zza {
        final /* synthetic */ zzlz zzagx;

        C06181(zzlz com_google_android_gms_internal_zzlz, GoogleApiClient googleApiClient) {
    ...
    public PendingResult<Status> zzb(GoogleApiClient googleApiClient) {
        return googleApiClient.zzb(new C06181(this, googleApiClient));
    }
}
