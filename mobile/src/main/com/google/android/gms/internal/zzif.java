...
public class zzif {
    ...
    class C05741 implements OnClickListener {
        ...
        C05741(zzif com_google_android_gms_internal_zzif, String str) {
    ...
    class C05752 implements OnClickListener {
        ...
        C05752(zzif com_google_android_gms_internal_zzif) {
            this.zzIN = com_google_android_gms_internal_zzif;
        }
    ...
    private void showDialog() {
        if (this.mContext instanceof Activity) {
            ...
            builder.setPositiveButton("Share", new C05741(this, zzaD));
            builder.setNegativeButton("Close", new C05752(this));
            builder.create().show();
            return;
        }
