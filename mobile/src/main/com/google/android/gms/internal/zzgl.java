...
public class zzgl extends zzhz {
    ...
    class C05411 implements Runnable {
        ...
        C05411(zzgl com_google_android_gms_internal_zzgl, zzhs com_google_android_gms_internal_zzhs) {
    ...
    public void zzbn() {
        ...
        zzid.zzIE.post(new C05411(this, com_google_android_gms_internal_zzhs));
    }
}
