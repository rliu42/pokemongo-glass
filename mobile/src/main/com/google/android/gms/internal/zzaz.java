...
public class zzaz implements OnGlobalLayoutListener, OnScrollChangedListener {
    ...
    class C04541 implements zzc<zzbe> {
        final /* synthetic */ JSONObject zzrv;
        final /* synthetic */ zzaz zzrw;

        C04541(zzaz com_google_android_gms_internal_zzaz, JSONObject jSONObject) {
    ...
    class C04552 implements zza {
        final /* synthetic */ zzaz zzrw;

        C04552(zzaz com_google_android_gms_internal_zzaz) {
            this.zzrw = com_google_android_gms_internal_zzaz;
        }
    ...
    class C04563 implements zzc<zzbe> {
        final /* synthetic */ zzaz zzrw;

        C04563(zzaz com_google_android_gms_internal_zzaz) {
            this.zzrw = com_google_android_gms_internal_zzaz;
        }
    ...
    class C04574 implements zza {
        final /* synthetic */ zzaz zzrw;

        C04574(zzaz com_google_android_gms_internal_zzaz) {
            this.zzrw = com_google_android_gms_internal_zzaz;
        }
    ...
    class C04585 extends BroadcastReceiver {
        final /* synthetic */ zzaz zzrw;

        C04585(zzaz com_google_android_gms_internal_zzaz) {
            this.zzrw = com_google_android_gms_internal_zzaz;
        }
    ...
    class C04596 implements zzdk {
        final /* synthetic */ zzaz zzrw;

        C04596(zzaz com_google_android_gms_internal_zzaz) {
            this.zzrw = com_google_android_gms_internal_zzaz;
        }
    ...
    class C04607 implements zzdk {
        final /* synthetic */ zzaz zzrw;

        C04607(zzaz com_google_android_gms_internal_zzaz) {
            this.zzrw = com_google_android_gms_internal_zzaz;
        }
    ...
    class C04618 implements zzdk {
        final /* synthetic */ zzaz zzrw;

        C04618(zzaz com_google_android_gms_internal_zzaz) {
            this.zzrw = com_google_android_gms_internal_zzaz;
        }
    ...
    class C04629 implements zzc<zzbe> {
        final /* synthetic */ zzaz zzrw;
        final /* synthetic */ JSONObject zzrx;

        C04629(zzaz com_google_android_gms_internal_zzaz, JSONObject jSONObject) {
            this.zzrw = com_google_android_gms_internal_zzaz;
    ...
    public zzaz(AdSizeParcel adSizeParcel, zzhs com_google_android_gms_internal_zzhs, VersionInfoParcel versionInfoParcel, View view, zzdz com_google_android_gms_internal_zzdz) {
        ...
        this.zzrs = new C04596(this);
        this.zzrt = new C04607(this);
        this.zzru = new C04618(this);
        ...
        try {
            this.zzrg.zza(new C04541(this, zzd(view)), new C04552(this));
        } catch (JSONException e) {
        } catch (Throwable e2) {
            zzb.zzb("Failure while processing active view data.", e2);
        }
        this.zzrg.zza(new C04563(this), new C04574(this));
    ...
    protected void zza(JSONObject jSONObject) {
        try {
            ...
            this.zzrg.zza(new C04629(this, jSONObject2), new zzis.zzb());
        } catch (Throwable th) {
