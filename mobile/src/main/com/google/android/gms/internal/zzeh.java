...
public final class zzeh implements zza {
    ...
    class C05181 implements Runnable {
        ...
        C05181(zzeh com_google_android_gms_internal_zzeh, zzeg com_google_android_gms_internal_zzeg) {
    ...
    public zzei zza(long j, long j2) {
        ...
        synchronized (this.zzpd) {
            ...
            zzid.zzIE.post(new C05181(this, com_google_android_gms_internal_zzeg));
