...
public class zzdl implements zzdk {
    ...
    class C04951 implements Runnable {
        ...
        class C04941 implements Runnable {
            ...
            final /* synthetic */ C04951 zzxE;

            C04941(C04951 c04951, JSONObject jSONObject) {
                this.zzxE = c04951;
        ...
        C04951(zzdl com_google_android_gms_internal_zzdl, Map map, zziz com_google_android_gms_internal_zziz) {
        ...
        public void run() {
            ...
            if (zzX == null) {
                ...
                zzid.zzIE.post(new C04941(this, zzX));
            }
        }
    }
    ...
    public void zza(zziz com_google_android_gms_internal_zziz, Map<String, String> map) {
        zzic.zza(new C04951(this, map, com_google_android_gms_internal_zziz));
    }
