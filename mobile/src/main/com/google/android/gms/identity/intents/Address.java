...
public final class Address {
    ...
    static class C04461 extends com.google.android.gms.common.api.Api.zza<zzoy, AddressOptions> {
        C04461() {
        }
    ...
    static class C04472 extends zza {
        final /* synthetic */ UserAddressRequest zzaDf;
        final /* synthetic */ int zzaDg;

        C04472(GoogleApiClient googleApiClient, UserAddressRequest userAddressRequest, int i) {
    ...
    public static void requestUserAddress(GoogleApiClient googleApiClient, UserAddressRequest request, int requestCode) {
        googleApiClient.zza(new C04472(googleApiClient, request, requestCode));
    }
}
