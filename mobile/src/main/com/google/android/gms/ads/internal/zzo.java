...
public class zzo {
    ...
    class C02031 implements Runnable {
        ...
        C02031(zzo com_google_android_gms_ads_internal_zzo, WeakReference weakReference) {
    ...
    zzo(zza com_google_android_gms_ads_internal_zza, zza com_google_android_gms_ads_internal_zzo_zza) {
        ...
        this.zzx = new C02031(this, new WeakReference(com_google_android_gms_ads_internal_zza));
    }
