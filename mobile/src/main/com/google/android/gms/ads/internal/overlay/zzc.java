...
public class zzc extends zzi implements OnAudioFocusChangeListener, OnBufferingUpdateListener, OnCompletionListener, OnErrorListener, OnInfoListener, OnPreparedListener, OnVideoSizeChangedListener, SurfaceTextureListener {
    ...
    class C01721 implements Runnable {
        ...
        C01721(zzc com_google_android_gms_ads_internal_overlay_zzc) {
    ...
    class C01732 implements Runnable {
        ...
        C01732(zzc com_google_android_gms_ads_internal_overlay_zzc) {
            this.zzBe = com_google_android_gms_ads_internal_overlay_zzc;
        }
    ...
    class C01743 implements Runnable {
        ...
        C01743(zzc com_google_android_gms_ads_internal_overlay_zzc, String str, String str2) {
            this.zzBe = com_google_android_gms_ads_internal_overlay_zzc;
            this.zzBf = str;
            this.zzBg = str2;
        }
    ...
    class C01754 implements Runnable {
        ...
        C01754(zzc com_google_android_gms_ads_internal_overlay_zzc) {
            this.zzBe = com_google_android_gms_ads_internal_overlay_zzc;
        }
    ...
    class C01765 implements Runnable {
        ...
        C01765(zzc com_google_android_gms_ads_internal_overlay_zzc) {
            this.zzBe = com_google_android_gms_ads_internal_overlay_zzc;
        }
    ...
    class C01776 implements Runnable {
        ...
        C01776(zzc com_google_android_gms_ads_internal_overlay_zzc) {
            this.zzBe = com_google_android_gms_ads_internal_overlay_zzc;
        }
    ...
    class C01787 implements Runnable {
        final /* synthetic */ zzc zzBe;

        C01787(zzc com_google_android_gms_ads_internal_overlay_zzc) {
            this.zzBe = com_google_android_gms_ads_internal_overlay_zzc;
        }
    ...
    public void onCompletion(MediaPlayer mp) {
        ...
        zzt(5);
        zzu(5);
        zzid.zzIE.post(new C01732(this));
    }
    ...
    public boolean onError(MediaPlayer mp, int what, int extra) {
        ...
        zzt(-1);
        zzu(-1);
        zzid.zzIE.post(new C01743(this, str, str2));
        return true;
    }

    public boolean onInfo(MediaPlayer mp, int what, int extra) {
        String str = (String) zzAO.get(Integer.valueOf(extra));
        zzb.m37v("AdMediaPlayerView MediaPlayer info: " + ((String) zzAO.get(Integer.valueOf(what))) + UpsightEndpoint.SIGNED_MESSAGE_SEPARATOR + str);
        return true;
    }
    ...
    public void onPrepared(MediaPlayer mediaPlayer) {
        ...
        zzt(2);
        this.zzAP.zzeR();
        zzid.zzIE.post(new C01721(this));
    ...
    public void onSurfaceTextureAvailable(SurfaceTexture surface, int width, int height) {
        ...
        zzes();
        zzid.zzIE.post(new C01754(this));
    }
    ...
    public boolean onSurfaceTextureDestroyed(SurfaceTexture surface) {
        ...
        zzid.zzIE.post(new C01765(this));
        zzt(true);
        return true;
    }
    ...
    public void onVideoSizeChanged(MediaPlayer mp, int width, int height) {
        zzb.m37v("AdMediaPlayerView size changed: " + width + " x " + height);
    ...
    public void pause() {
        ...
        if (zzew() && this.zzAS.isPlaying()) {
            this.zzAS.pause();
            zzt(4);
            zzid.zzIE.post(new C01787(this));
        }
        zzu(4);
    }
    ...
    public void play() {
        ...
        if (zzew()) {
            this.zzAS.start();
            zzt(3);
            zzid.zzIE.post(new C01776(this));
        }
        zzu(3);
    }

    public void seekTo(int millis) {
        zzb.m37v("AdMediaPlayerView seek " + millis);
        if (zzew()) {
