...
public abstract class zzc extends zzb implements zzg, zzfi {
    ...
    class C01921 implements Runnable {
        ...
        C01921(zzc com_google_android_gms_ads_internal_zzc, zza com_google_android_gms_internal_zzhs_zza) {
    ...
    class C01952 implements Runnable {
        ...
        class C01931 implements OnTouchListener {
            final /* synthetic */ zze zzoE;
            final /* synthetic */ C01952 zzoF;

            C01931(C01952 c01952, zze com_google_android_gms_ads_internal_zze) {
                this.zzoF = c01952;
        ...
        class C01942 implements OnClickListener {
            ...
            C01942(C01952 c01952, zze com_google_android_gms_ads_internal_zze) {
                this.zzoF = c01952;
                this.zzoE = com_google_android_gms_ads_internal_zze;
            }
        ...
        C01952(zzc com_google_android_gms_ads_internal_zzc, zza com_google_android_gms_internal_zzhs_zza, zzcg com_google_android_gms_internal_zzcg) {
            this.zzoC = com_google_android_gms_ads_internal_zzc;
            this.zzoB = com_google_android_gms_internal_zzhs_zza;
        ...
        public void run() {
            ...
            zza.setOnTouchListener(new C01931(this, com_google_android_gms_ads_internal_zze));
            zza.setOnClickListener(new C01942(this, com_google_android_gms_ads_internal_zze));
    ...
    protected void zza(zza com_google_android_gms_internal_zzhs_zza, zzcg com_google_android_gms_internal_zzcg) {
        if (com_google_android_gms_internal_zzhs_zza.errorCode != -2) {
            zzid.zzIE.post(new C01921(this, com_google_android_gms_internal_zzhs_zza));
            return;
        }
        ...
        zzid.zzIE.post(new C01952(this, com_google_android_gms_internal_zzhs_zza, com_google_android_gms_internal_zzcg));
    }
