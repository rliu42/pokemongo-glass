...
public class zzh {
    ...
    class C01661 implements zzdk {
        final /* synthetic */ zzh zzwO;

        /* renamed from: com.google.android.gms.ads.internal.formats.zzh.1.1 */
        class C01651 implements com.google.android.gms.internal.zzja.zza {
            final /* synthetic */ Map zzwP;
            final /* synthetic */ C01661 zzwQ;

            C01651(C01661 c01661, Map map) {
                this.zzwQ = c01661;
                this.zzwP = map;
            }
        ...
        C01661(zzh com_google_android_gms_ads_internal_formats_zzh) {
        ...
        public void zza(zziz com_google_android_gms_internal_zziz, Map<String, String> map) {
            this.zzwO.zzoM.zzhe().zza(new C01651(this, map));
    ...
    class C01672 implements zzdk {
        final /* synthetic */ zzh zzwO;

        C01672(zzh com_google_android_gms_ads_internal_formats_zzh) {
            this.zzwO = com_google_android_gms_ads_internal_formats_zzh;
        }
    ...
    class C01683 implements zzdk {
        final /* synthetic */ zzh zzwO;

        C01683(zzh com_google_android_gms_ads_internal_formats_zzh) {
            this.zzwO = com_google_android_gms_ads_internal_formats_zzh;
        }
    ...
    class C01694 implements zzdk {
        final /* synthetic */ zzh zzwO;

        C01694(zzh com_google_android_gms_ads_internal_formats_zzh) {
            this.zzwO = com_google_android_gms_ads_internal_formats_zzh;
        }
    ...
    class C01705 implements zzdk {
        final /* synthetic */ zzh zzwO;

        C01705(zzh com_google_android_gms_ads_internal_formats_zzh) {
            this.zzwO = com_google_android_gms_ads_internal_formats_zzh;
        }
    ...
    public zziz zzdC() {
        ...
        this.zzwJ.zza("/loadHtml", new C01661(this));
        this.zzwJ.zza("/showOverlay", new C01672(this));
        this.zzwJ.zza("/hideOverlay", new C01683(this));
        this.zzoM.zzhe().zza("/hideOverlay", new C01694(this));
        this.zzoM.zzhe().zza("/sendMessageToSdk", new C01705(this));
        return this.zzoM;
    }
