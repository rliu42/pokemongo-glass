...
public class zzj extends zza implements OnClickListener, OnTouchListener, OnGlobalLayoutListener, OnScrollChangedListener {
    ...
    class C01711 implements Runnable {
        ...
        C01711(zzj com_google_android_gms_ads_internal_formats_zzj, zzh com_google_android_gms_ads_internal_formats_zzh) {
    ...
    public void zzb(zzd com_google_android_gms_dynamic_zzd) {
        synchronized (this.zzpd) {
            ...
            zzid.zzIE.post(new C01711(this, com_google_android_gms_ads_internal_formats_zzh));
