...
public class zzi extends zzj<zzf> implements zzqw {
    ...
    private static class zza extends com.google.android.gms.signin.internal.zzd.zza {
        ...
        class C06671 implements Runnable {
            ...
            C06671(zza com_google_android_gms_signin_internal_zzi_zza, List list, String str, zzf com_google_android_gms_signin_internal_zzf) {
        ...
        class C06682 implements Runnable {
            ...
            C06682(zza com_google_android_gms_signin_internal_zzi_zza, String str, String str2, zzf com_google_android_gms_signin_internal_zzf) {
                this.zzaVq = com_google_android_gms_signin_internal_zzi_zza;
                this.zzaVo = str;
                this.zzaVr = str2;
                this.zzaVp = com_google_android_gms_signin_internal_zzf;
        ...
        public void zza(String str, String str2, zzf com_google_android_gms_signin_internal_zzf) throws RemoteException {
            this.zzaVm.submit(new C06682(this, str, str2, com_google_android_gms_signin_internal_zzf));
        }

        public void zza(String str, List<Scope> list, zzf com_google_android_gms_signin_internal_zzf) throws RemoteException {
            this.zzaVm.submit(new C06671(this, list, str, com_google_android_gms_signin_internal_zzf));
        }
    }
