...
public abstract class GoogleApiClient {
    ...
    public static final class Builder {
        ...
        class C02211 implements Runnable {
            ...
            C02211(Builder builder, GoogleApiClient googleApiClient) {
                this.zzaaU = builder;
        ...
        private GoogleApiClient zznC() {
            ...
            if (zza == null) {
                new Handler(this.mContext.getMainLooper()).post(new C02211(this, com_google_android_gms_internal_zzli));
            } else {
