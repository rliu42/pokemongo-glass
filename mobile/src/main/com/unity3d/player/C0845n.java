...
public final class C0845n implements C0834i {

    /* renamed from: com.unity3d.player.n.1 */
    class C08441 extends Fragment {
        final /* synthetic */ List f191a;
        final /* synthetic */ FragmentManager f192b;
        final /* synthetic */ Runnable f193c;
        final /* synthetic */ C0845n f194d;

        C08441(C0845n c0845n, List list, FragmentManager fragmentManager, Runnable runnable) {
            this.f194d = c0845n;
            this.f191a = list;
        ...
        public final void onRequestPermissionsResult(int i, String[] strArr, int[] iArr) {
            if (i == 15881) {
                ...
                while (i2 < strArr.length && i2 < iArr.length) {
                    C0843m.Log(4, strArr[i2] + (iArr[i2] == 0 ? " granted" : " denied"));
                    i2++;
                }
    ...
    public final void m147a(Activity activity, Runnable runnable) {
        if (activity != null) {
            ...
            try {
                ...
                if (C0845n.m146a(activityInfo) || C0845n.m146a(applicationInfo)) {
                    runnable.run();
                    return;
                }
            } catch (Exception e) {
            ...
            try {
                ...
                for (String str : packageInfo.requestedPermissions) {
                    try {
                        ...
                        C0843m.Log(5, "Failed to get permission info for " + str + ", manifest likely missing custom permission declaration");
                        C0843m.Log(5, "Permission " + str + " ignored");
                    }
                }
                ...
                Fragment c08441 = new C08441(this, linkedList, fragmentManager, runnable);
                FragmentTransaction beginTransaction = fragmentManager.beginTransaction();
                beginTransaction.add(0, c08441);
                beginTransaction.commit();
            } catch (Exception e3) {
                C0843m.Log(6, "Unable to query for permission: " + e3.getMessage());
            }
        }
    }
}
