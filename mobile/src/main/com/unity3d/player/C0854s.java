...
public final class C0854s extends Dialog implements TextWatcher, OnClickListener {
    ...
    class C08511 implements OnFocusChangeListener {
        final /* synthetic */ C0854s f221a;

        C08511(C0854s c0854s) {
            this.f221a = c0854s;
        }
    ...
    class C08522 extends EditText {
        final /* synthetic */ C0854s f222a;

        C08522(C0854s c0854s, Context context) {
            this.f222a = c0854s;
            super(context);
        }
    ...
    class C08533 implements OnEditorActionListener {
        final /* synthetic */ C0854s f223a;

        C08533(C0854s c0854s) {
            this.f223a = c0854s;
        }
    ...
    public C0854s(Context context, UnityPlayer unityPlayer, String str, int i, boolean z, boolean z2, boolean z3, String str2) {
        super(context);
        this.f226a = null;
        this.f227b = null;
        this.f226a = context;
        ...
        editText.setOnFocusChangeListener(new C08511(this));
    }
    ...
    private void m170a(EditText editText, String str, int i, boolean z, boolean z2, boolean z3, String str2) {
        ...
        editText.setInputType(C0854s.m167a(i, z, z2, z3));
    ...
    protected final View createSoftInputView() {
        ...
        View c08522 = new C08522(this, this.f226a);
        LayoutParams layoutParams = new RelativeLayout.LayoutParams(-1, -2);
        layoutParams.addRule(15);
        layoutParams.addRule(0, 1057292290);
        c08522.setLayoutParams(layoutParams);
        c08522.setId(1057292289);
        relativeLayout.addView(c08522);
        c08522 = new Button(this.f226a);
        c08522.setText(this.f226a.getResources().getIdentifier("ok", "string", "android"));
        layoutParams = new RelativeLayout.LayoutParams(-2, -2);
        layoutParams.addRule(15);
        layoutParams.addRule(11);
        c08522.setLayoutParams(layoutParams);
        c08522.setId(1057292290);
        c08522.setBackgroundColor(0);
        relativeLayout.addView(c08522);
        ((EditText) relativeLayout.findViewById(1057292289)).setOnEditorActionListener(new C08533(this));
