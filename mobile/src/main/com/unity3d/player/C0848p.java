...
public final class C0848p implements C0835j {
    ...
    class C08471 implements Runnable {
        final /* synthetic */ C0848p f196a;

        C08471(C0848p c0848p) {
            this.f196a = c0848p;
        }

        private static void m150a(View view, MotionEvent motionEvent) {
            if (C0849q.f201b) {
                C0849q.f209j.m115a(view, motionEvent);
            }
        }
                    ...
                    if ((source & 2) != 0) {
                        switch (motionEvent.getAction() & MotionEventCompat.ACTION_MASK) {
                            ...
                            case Place.TYPE_ATM /*6*/:
                                ...
                                break;
                            default:
                                C08471.m150a(decorView, motionEvent);
                                break;
                        }
                    } else if ((source & 4) != 0) {
    ...
    public C0848p(ContextWrapper contextWrapper) {
        this.f197a = new ConcurrentLinkedQueue();
        this.f199c = new C08471(this);
    ...
    private static PointerCoords[] m153a(int i, float[] fArr) {
        ...
        C0848p.m151a(pointerCoordsArr, fArr, 0);
    ...
    public final void m155a(long j, long j2, int i, int i2, int[] iArr, float[] fArr, int i3, float f, float f2, int i4, int i5, int i6, int i7, int i8, long[] jArr, float[] fArr2) {
        if (this.f198b != null) {
            MotionEvent obtain = MotionEvent.obtain(j, j2, i, i2, iArr, C0848p.m153a(i2, fArr), i3, f, f2, i4, i5, i6, i7);
            int i9 = 0;
            for (int i10 = 0; i10 < i8; i10++) {
                PointerCoords[] pointerCoordsArr = new PointerCoords[i2];
                i9 = C0848p.m151a(pointerCoordsArr, fArr2, i9);
