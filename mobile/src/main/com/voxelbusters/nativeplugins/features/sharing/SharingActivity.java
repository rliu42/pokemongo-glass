...
public class SharingActivity extends Activity {
    ...
    class C09852 implements OnKeyListener {
        C09852() {
        }
    ...
    private void shareItem(String message, String urlString, String imagePath, String type, String[] excludedShareOptions) {
        ...
        if (failedSharing) {
            Builder alertDialogBuilder = new Builder(this).setTitle("Share").setMessage("No services found!").setPositiveButton(17039370, new C09841());
            alertDialogBuilder.setOnKeyListener(new C09852());
