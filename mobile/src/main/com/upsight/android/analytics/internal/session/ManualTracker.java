...
class ManualTracker implements UpsightLifeCycleTracker {
    ...
    class C08941 implements UpsightDataStoreListener<Set<ApplicationStatus>> {
        C08941() {
        }
    ...
    class C08952 implements UpsightDataStoreListener<Set<ApplicationStatus>> {
        C08952() {
        }
    ...
    public void track(Activity activity, ActivityState activityState, SessionInitializer sessionInitializer) {
        switch (C08963.f266xa86dd1d6[activityState.ordinal()]) {
            case C1391R.styleable.LoadingImageView_imageAspectRatio /*1*/:
                if (this.mActivitySet.isEmpty()) {
                    this.mDataStore.fetch(ApplicationStatus.class, new C08941());
            ...
            case C1391R.styleable.LoadingImageView_circleCrop /*2*/:
                ...
                if (!activity.isChangingConfigurations() && this.mActivitySet.isEmpty()) {
                    this.mDataStore.fetch(ApplicationStatus.class, new C08952());
