...
public class UpsightPlugin extends AbstractUpsightPlugin implements ActivityLifecycleCallbacks {
    ...
    class C09751 implements OnUnregisterListener {
        C09751() {
        }
    ...
    class C09762 implements OnRegisterListener {
        C09762() {
        }
    ...
    public void unregisterForPushNotifications() {
        ...
        UpsightGooglePushServices.unregister(this.mUpsight, new C09751());
    }

    public void registerForPushNotifications() {
        Log.i(Upsight.LOG_TAG, "registering for push notifications");
        UpsightGooglePushServices.register(this.mUpsight, new C09762());
    }
