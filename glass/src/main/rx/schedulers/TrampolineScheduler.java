...
public final class TrampolineScheduler extends Scheduler {
    ...
    private static class InnerCurrentThreadScheduler extends Worker implements Subscription {
        ...
        class C13751 implements Action0 {
            ...
            C13751(TimedAction timedAction) {
        ...
        private Subscription enqueue(Action0 action, long execTime) {
            ...
            TimedAction timedAction = new TimedAction(Long.valueOf(execTime), COUNTER_UPDATER.incrementAndGet(this), null);
            this.queue.add(timedAction);
            if (this.wip.getAndIncrement() != 0) {
                return Subscriptions.create(new C13751(timedAction));
            }
            do {
