...
public class InstanceIDListenerService extends Service {
    ...
    class C04491 extends Handler {
        ...
        C04491(InstanceIDListenerService instanceIDListenerService, Looper looper) {
    ...
    class C04502 extends BroadcastReceiver {
        ...
        C04502(InstanceIDListenerService instanceIDListenerService) {
            this.zzaDJ = instanceIDListenerService;
        }
    ...
    public InstanceIDListenerService() {
        this.zzaDD = new MessengerCompat(new C04491(this, Looper.getMainLooper()));
        this.zzaDE = new C04502(this);
    }
