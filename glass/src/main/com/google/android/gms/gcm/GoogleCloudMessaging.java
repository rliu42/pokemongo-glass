...
public class GoogleCloudMessaging {
    ...
    class C04391 extends Handler {
        final /* synthetic */ GoogleCloudMessaging zzaCB;

        C04391(GoogleCloudMessaging googleCloudMessaging, Looper looper) {
    ...
    public GoogleCloudMessaging() {
        ...
        this.zzaCA = new Messenger(new C04391(this, Looper.getMainLooper()));
    }
