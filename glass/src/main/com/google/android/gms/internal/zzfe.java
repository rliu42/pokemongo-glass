...
public class zzfe extends zzfh {
    ...
    class C05331 implements OnClickListener {
        ...
        C05331(zzfe com_google_android_gms_internal_zzfe, String str, String str2) {
    ...
    class C05342 implements OnClickListener {
        ...
        C05342(zzfe com_google_android_gms_internal_zzfe) {
            this.zzAu = com_google_android_gms_internal_zzfe;
        }
        ...
        if (this.mContext == null) {
            ...
            if (TextUtils.isEmpty(str)) {
                ...
                if (zzp.zzbv().zzaB(zzaj)) {
                    ...
                    zzK.setTitle(zzp.zzby().zzd(C0160R.string.store_picture_title, "Save image"));
                    zzK.setMessage(zzp.zzby().zzd(C0160R.string.store_picture_message, "Allow Ad to store image in Picture gallery?"));
                    zzK.setPositiveButton(zzp.zzby().zzd(C0160R.string.accept, "Accept"), new C05331(this, str, zzaj));
                    zzK.setNegativeButton(zzp.zzby().zzd(C0160R.string.decline, "Decline"), new C05342(this));
                    zzK.create().show();
                    return;
                }
