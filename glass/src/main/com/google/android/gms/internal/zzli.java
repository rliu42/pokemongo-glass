...
public final class zzli extends GoogleApiClient {
    ...
    class C06011 implements zze {
        final /* synthetic */ zzli zzacr;

        C06011(zzli com_google_android_gms_internal_zzli) {
    ...
    class C06022 implements ConnectionCallbacks {
        final /* synthetic */ zzli zzacr;

        C06022(zzli com_google_android_gms_internal_zzli) {
            this.zzacr = com_google_android_gms_internal_zzli;
        }
    ...
    class C06033 implements com.google.android.gms.common.internal.zzk.zza {
        final /* synthetic */ zzli zzacr;

        C06033(zzli com_google_android_gms_internal_zzli) {
            this.zzacr = com_google_android_gms_internal_zzli;
        }
    ...
    class C06044 implements OnConnectionFailedListener {
        final /* synthetic */ zzli zzacr;
        final /* synthetic */ Api zzacs;
        final /* synthetic */ int zzact;

        C06044(zzli com_google_android_gms_internal_zzli, Api api, int i) {
            this.zzacr = com_google_android_gms_internal_zzli;
            this.zzacs = api;
            this.zzact = i;
        }
    ...
    class C06055 implements ConnectionCallbacks {
        final /* synthetic */ zzli zzacr;
        final /* synthetic */ AtomicReference zzacu;
        final /* synthetic */ zzlo zzacv;

        C06055(zzli com_google_android_gms_internal_zzli, AtomicReference atomicReference, zzlo com_google_android_gms_internal_zzlo) {
            this.zzacr = com_google_android_gms_internal_zzli;
    ...
    class C06066 implements OnConnectionFailedListener {
        final /* synthetic */ zzli zzacr;
        final /* synthetic */ zzlo zzacv;

        C06066(zzli com_google_android_gms_internal_zzli, zzlo com_google_android_gms_internal_zzlo) {
            this.zzacr = com_google_android_gms_internal_zzli;
            this.zzacv = com_google_android_gms_internal_zzlo;
        }
    ...
    class C06077 implements ResultCallback<Status> {
        final /* synthetic */ GoogleApiClient zzWT;
        final /* synthetic */ zzli zzacr;
        final /* synthetic */ zzlo zzacv;
        final /* synthetic */ boolean zzacw;

        C06077(zzli com_google_android_gms_internal_zzli, zzlo com_google_android_gms_internal_zzlo, boolean z, GoogleApiClient googleApiClient) {
            this.zzacr = com_google_android_gms_internal_zzli;
            this.zzacv = com_google_android_gms_internal_zzlo;
            this.zzacw = z;
    ...
    class C06088 implements Runnable {
        final /* synthetic */ zzli zzacr;
        final /* synthetic */ FragmentActivity zzacx;

        C06088(zzli com_google_android_gms_internal_zzli, FragmentActivity fragmentActivity) {
            this.zzacr = com_google_android_gms_internal_zzli;
    ...
    public zzli(Context context, Looper looper, com.google.android.gms.common.internal.zzf com_google_android_gms_common_internal_zzf, GoogleApiAvailability googleApiAvailability, com.google.android.gms.common.api.Api.zza<? extends zzqw, zzqx> com_google_android_gms_common_api_Api_zza__extends_com_google_android_gms_internal_zzqw__com_google_android_gms_internal_zzqx, Map<Api<?>, ApiOptions> map, ArrayList<ConnectionCallbacks> arrayList, ArrayList<OnConnectionFailedListener> arrayList2, int i) {
        ...
        this.zzaco = new C06011(this);
        this.zzacp = new C06022(this);
        this.zzacq = new C06033(this);
    ...
    private void zza(GoogleApiClient googleApiClient, zzlo com_google_android_gms_internal_zzlo, boolean z) {
        zzlx.zzagw.zzb(googleApiClient).setResultCallback(new C06077(this, com_google_android_gms_internal_zzlo, z, googleApiClient));
    }
    ...
    public PendingResult<Status> clearDefaultAccountAndReconnect() {
        ...
        if (this.zzacg.containsKey(zzlx.zzRk)) {
            ...
            ConnectionCallbacks c06055 = new C06055(this, atomicReference, com_google_android_gms_internal_zzlo);
            GoogleApiClient build = new Builder(this.mContext).addApi(zzlx.API).addConnectionCallbacks(c06055).addOnConnectionFailedListener(new C06066(this, com_google_android_gms_internal_zzlo)).setHandler(this.zzace).build();
    ...
    public void stopAutoManage(FragmentActivity lifecycleActivity) {
        if (this.zzaaM >= 0) {
            ...
            if (zza == null) {
                new Handler(this.mContext.getMainLooper()).post(new C06088(this, lifecycleActivity));
                return;
            } else {
                zza.zzbp(this.zzaaM);
                return;
