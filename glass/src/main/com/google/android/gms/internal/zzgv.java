...
public final class zzgv {
    ...
    class C05551 implements zzdk {
        final /* synthetic */ zzgv zzFT;

        C05551(zzgv com_google_android_gms_internal_zzgv) {
    ...
    class C05562 implements zzdk {
        final /* synthetic */ zzgv zzFT;

        C05562(zzgv com_google_android_gms_internal_zzgv) {
            this.zzFT = com_google_android_gms_internal_zzgv;
        }
    ...
    public zzgv(String str, String str2) {
        ...
        this.zzFP = new zzin();
        this.zzFR = new C05551(this);
        this.zzFS = new C05562(this);
        this.zzFO = str2;
        this.zzBY = str;
    }
