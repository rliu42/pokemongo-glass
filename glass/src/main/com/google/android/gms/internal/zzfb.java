...
public class zzfb extends zzfh {
    ...
    class C05301 implements OnClickListener {
        ...
        C05301(zzfb com_google_android_gms_internal_zzfb) {
    ...
    class C05312 implements OnClickListener {
        ...
        C05312(zzfb com_google_android_gms_internal_zzfb) {
            this.zzAa = com_google_android_gms_internal_zzfb;
        }
    ...
    public void execute() {
        if (this.mContext == null) {
            ...
            zzK.setTitle(zzp.zzby().zzd(C0160R.string.create_calendar_title, "Create calendar event"));
            zzK.setMessage(zzp.zzby().zzd(C0160R.string.create_calendar_message, "Allow Ad to create a calendar event?"));
            zzK.setPositiveButton(zzp.zzby().zzd(C0160R.string.accept, "Accept"), new C05301(this));
            zzK.setNegativeButton(zzp.zzby().zzd(C0160R.string.decline, "Decline"), new C05312(this));
            zzK.create().show();
        } else {
