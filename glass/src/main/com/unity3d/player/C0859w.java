...
public final class C0859w extends FrameLayout implements OnBufferingUpdateListener, OnCompletionListener, OnPreparedListener, OnVideoSizeChangedListener, Callback, MediaPlayerControl {
    ...
    class C08581 implements Runnable {
        final /* synthetic */ C0859w f239a;

        C08581(C0859w c0859w) {
            this.f239a = c0859w;
        }
    ...
    protected C0859w(UnityPlayer unityPlayer, Context context, String str, int i, int i2, int i3, boolean z, long j, long j2) {
        super(context);
        this.f259t = false;
        this.f260u = false;
        this.f261v = 0;
        ...
        this.f250k = j2;
        if (f240a) {
            C0859w.m195a("fileName: " + this.f245f);
        }
        if (f240a) {
            C0859w.m195a("backgroundColor: " + i);
        }
        if (f240a) {
            C0859w.m195a("controlMode: " + this.f246g);
        }
        if (f240a) {
            C0859w.m195a("scalingMode: " + this.f247h);
        }
        if (f240a) {
            C0859w.m195a("isURL: " + this.f248i);
        }
        if (f240a) {
            C0859w.m195a("videoOffset: " + this.f249j);
        }
        if (f240a) {
            C0859w.m195a("videoLength: " + this.f250k);
        }
        setFocusable(true);
    ...
    private void m194a() {
        ...
        try {
            ...
            if (f240a) {
                C0859w.m195a("error: " + e2.getMessage() + e2);
            }
            onDestroy();
        }
    }
    ...
    private void m196b() {
        if (!isPlaying()) {
            if (f240a) {
                C0859w.m195a("startVideoPlayback");
            }
            updateVideoLayout();
            if (!this.f262w) {
                start();
    ...
    public final void onBufferingUpdate(MediaPlayer mediaPlayer, int i) {
        if (f240a) {
            C0859w.m195a("onBufferingUpdate percent:" + i);
        }
        this.f261v = i;
    }
    ...
    public final void onCompletion(MediaPlayer mediaPlayer) {
        if (f240a) {
            C0859w.m195a("onCompletion called");
        }
        onDestroy();
    }
    ...
    protected final void onDestroy() {
        onPause();
        doCleanUp();
        UnityPlayer.m66a(new C08581(this));
    }
    ...
    public final void onPrepared(MediaPlayer mediaPlayer) {
        if (f240a) {
            C0859w.m195a("onPrepared called");
        }
        this.f260u = true;
    ...
    public final void onVideoSizeChanged(MediaPlayer mediaPlayer, int i, int i2) {
        if (f240a) {
            C0859w.m195a("onVideoSizeChanged called " + i + "x" + i2);
        }
        if (i != 0 && i2 != 0) {
            this.f259t = true;
            this.f255p = i;
            ...
            C0859w.m195a("invalid video width(" + i + ") or height(" + i2 + ")");
        }
    }
    ...
    public final void surfaceChanged(SurfaceHolder surfaceHolder, int i, int i2, int i3) {
        if (f240a) {
            C0859w.m195a("surfaceChanged called " + i + MinimalPrettyPrinter.DEFAULT_ROOT_VALUE_SEPARATOR + i2 + "x" + i3);
        }
    ...
    public final void surfaceCreated(SurfaceHolder surfaceHolder) {
        if (f240a) {
            C0859w.m195a("surfaceCreated called");
        }
        m194a();
        seekTo(this.f263x);
    }
    ...
    public final void surfaceDestroyed(SurfaceHolder surfaceHolder) {
        if (f240a) {
            C0859w.m195a("surfaceDestroyed called");
        }
        doCleanUp();
    }
    ...
    protected final void updateVideoLayout() {
        if (f240a) {
            C0859w.m195a("updateVideoLayout");
        }
        ...
        if (f240a) {
            C0859w.m195a("frameWidth = " + i + "; frameHeight = " + i2);
        }
