        ...
        try {
            ...
            if (bundle != null && bundle.containsKey(KEY_SESSION)) {
                try {
                    ...
                    this.mLogger.m199e(Upsight.LOG_TAG, String.format("Unexpected error: Class: %s was not found.", new Object[]{session}), e);
                } catch (IllegalAccessException e2) {
                    this.mLogger.m199e(Upsight.LOG_TAG, String.format("Unexpected error: Class: %s does not have public access.", new Object[]{session}), e2);
                } catch (InstantiationException e3) {
                    this.mLogger.m199e(Upsight.LOG_TAG, String.format("Unexpected error: Class: %s could not be instantiated", new Object[]{session}), e3);
                }
            }
