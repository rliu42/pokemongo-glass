...
public final class ConfigurationModule_ProvideConfigurationManagerFactory implements Factory<ConfigurationManager> {
    ...
    public ConfigurationManager get() {
        ConfigurationManager provided = this.module.provideConfigurationManager((UpsightContext) this.upsightProvider.get(), (ConfigurationResponseParser) this.responseParserProvider.get(), (ManagerConfigParser) this.managerConfigParserProvider.get());
        if (provided != null) {
            return provided;
        }
