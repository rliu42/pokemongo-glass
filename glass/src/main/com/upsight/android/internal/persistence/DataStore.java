...
class DataStore implements UpsightDataStore {
    ...
    class C09131 implements Action1<List<T>> {
        final /* synthetic */ UpsightDataStoreListener val$listener;

        C09131(UpsightDataStoreListener upsightDataStoreListener) {
            this.val$listener = upsightDataStoreListener;
        }
    ...
    class C09142 implements Action1<Throwable> {
        final /* synthetic */ UpsightDataStoreListener val$listener;

        C09142(UpsightDataStoreListener upsightDataStoreListener) {
            this.val$listener = upsightDataStoreListener;
        }
    ...
    class C09153 implements Action1<List<T>> {
        final /* synthetic */ UpsightDataStoreListener val$listener;

        C09153(UpsightDataStoreListener upsightDataStoreListener) {
            this.val$listener = upsightDataStoreListener;
        }
    ...
    class C09164 implements Action1<Throwable> {
        final /* synthetic */ UpsightDataStoreListener val$listener;

        C09164(UpsightDataStoreListener upsightDataStoreListener) {
            this.val$listener = upsightDataStoreListener;
        }
    ...
    class C09175 implements Action1<List<T>> {
        final /* synthetic */ UpsightDataStoreListener val$listener;

        C09175(UpsightDataStoreListener upsightDataStoreListener) {
            this.val$listener = upsightDataStoreListener;
        }
    ...
    class C09186 implements Action1<Throwable> {
        final /* synthetic */ UpsightDataStoreListener val$listener;

        C09186(UpsightDataStoreListener upsightDataStoreListener) {
            this.val$listener = upsightDataStoreListener;
        }
    ...
    class C09197 implements Action1<T> {
        final /* synthetic */ UpsightDataStoreListener val$listener;

        C09197(UpsightDataStoreListener upsightDataStoreListener) {
            this.val$listener = upsightDataStoreListener;
        }
    ...
    class C09208 implements Action1<Throwable> {
        final /* synthetic */ UpsightDataStoreListener val$listener;

        C09208(UpsightDataStoreListener upsightDataStoreListener) {
            this.val$listener = upsightDataStoreListener;
        }
    ...
    class C09219 implements Action1<T> {
        final /* synthetic */ UpsightDataStoreListener val$listener;

        C09219(UpsightDataStoreListener upsightDataStoreListener) {
            this.val$listener = upsightDataStoreListener;
        }
    ...
    public <T> UpsightSubscription fetch(Class<T> clazz, UpsightDataStoreListener<Set<T>> listener) {
        if (clazz == null) {
            ...
            return Subscriptions.from(fetchObservable(clazz).toList().subscribeOn(this.mSubscribeOnScheduler).observeOn(this.mObserveOnScheduler).subscribe(new C09131(listener), new C09142(listener)));
        } else {
    ...
    public <T> UpsightSubscription fetch(Class<T> clazz, Set<String> ids, UpsightDataStoreListener<Set<T>> listener) {
        return Subscriptions.from(fetchObservable(clazz, (String[]) ids.toArray(new String[ids.size()])).toList().subscribeOn(this.mSubscribeOnScheduler).observeOn(this.mObserveOnScheduler).subscribe(new C09153(listener), new C09164(listener)));
    }

    public <T> UpsightSubscription remove(Class<T> clazz, Set<String> ids, UpsightDataStoreListener<Set<T>> listener) {
        return Subscriptions.from(removeObservable(clazz, (String[]) ids.toArray(new String[ids.size()])).toList().subscribeOn(this.mSubscribeOnScheduler).observeOn(this.mObserveOnScheduler).subscribe(new C09175(listener), new C09186(listener)));
    }
    ...
    public <T> UpsightSubscription store(T object, UpsightDataStoreListener<T> listener) {
        return Subscriptions.from(storeObservable(object).subscribeOn(this.mSubscribeOnScheduler).observeOn(this.mObserveOnScheduler).subscribe(new C09197(listener), new C09208(listener)));
    }
    ...
    public <T> UpsightSubscription remove(T object, UpsightDataStoreListener<T> listener) {
        if (listener != null) {
            return Subscriptions.from(removeObservable(object).subscribeOn(this.mSubscribeOnScheduler).observeOn(this.mObserveOnScheduler).subscribe(new C09219(listener), new AnonymousClass10(listener)));
        }
