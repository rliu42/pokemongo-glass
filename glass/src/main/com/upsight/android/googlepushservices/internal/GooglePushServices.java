...
public class GooglePushServices implements UpsightGooglePushServicesApi {
    ...
    class C09031 implements OnSubscribe<String> {
    ...
    class C09042 implements Observer<String> {
        C09042() {
        }
    ...
    class C09053 implements OnSubscribe<String> {
        C09053() {
        }
    ...
    class C09064 implements Observer<String> {
        C09064() {
        }
    ...
    private void registerInBackground(String projectId) {
        ...
        Observable.create(new C09031(projectId)).subscribeOn(this.mComputationScheduler).observeOn(HandlerScheduler.from(this.mUiThreadHandler)).subscribe(new C09042());
    }
    ...
    private void unregisterInBackground() {
        ...
        Observable.create(new C09053()).subscribeOn(this.mComputationScheduler).observeOn(HandlerScheduler.from(this.mUiThreadHandler)).subscribe(new C09064());
    }
    ...
    private String getRegistrationId() {
        ...
        if (this.mPrefs.getInt(PROPERTY_APP_VERSION, ExploreByTouchHelper.INVALID_ID) != getAppVersion()) {
            return null;
        }
