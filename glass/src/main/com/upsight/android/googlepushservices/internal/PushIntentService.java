...
public final class PushIntentService extends IntentService {
        ...
        if (!TextUtils.isEmpty(stringValue) && TextUtils.isDigitsOnly(stringValue)) {
            try {
                ...
                if (defaultValue == null) {
                    logger.m200e(LOG_TAG, e, String.format("Could not parse %s. Setting to null.", new Object[]{stringValue}), new Object[0]);
                } else {
                    logger.m200e(LOG_TAG, e, String.format("Could not parse %s. Setting to %d.", new Object[]{stringValue, defaultValue}), new Object[0]);
                }
            }
        }
        return integerValue;
    ...
    private void interpretPushEvent(Bundle extras) {
        ...
        if (uri != null) {
            ...
            switch (C09071.f267x51d6a9c0[checkUri(logger, uri).ordinal()]) {
    ...
    public UriTypes checkUri(UpsightLogger logger, Uri uri) {
        ...
        if (TextUtils.isEmpty(host) || TextUtils.isEmpty(scheme)) {
            logger.m199e(LOG_TAG, String.format("Invalid URI, host or scheme is null or empty: %s.", new Object[]{uri}), new Object[0]);
            ...
            try {
                ...
                logger.m199e(LOG_TAG, String.format("Nothing registered for %s", new Object[]{uri}), new Object[0]);
                return UriTypes.INVALID;
            }
