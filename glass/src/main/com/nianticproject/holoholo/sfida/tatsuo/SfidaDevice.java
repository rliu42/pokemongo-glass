...
public class SfidaDevice {
    ...
    class C07901 extends BluetoothGattCallback {
        C07901() {
        }
        ...
        public void onCharacteristicChanged(BluetoothGatt gatt, BluetoothGattCharacteristic characteristic) {
            ...
            onButtonUpdated((value[0] * AccessibilityNodeInfoCompat.ACTION_NEXT_AT_MOVEMENT_GRANULARITY) + value[1]);
        }
    ...
    public SfidaDevice(Context context, BluetoothDevice device) {
        ...
        this.bluetoothGattCallback = new C07901();
