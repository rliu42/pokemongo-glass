...
abstract class ModernAsyncTask<Params, Progress, Result> {
    ...
    class C00272 extends WorkerRunnable<Params, Result> {
        C00272() {
            super();
        }
    ...
    class C00283 extends FutureTask<Result> {
        C00283(Callable x0) {
            super(x0);
        }
    ...
    public ModernAsyncTask() {
        ...
        this.mWorker = new C00272();
        this.mFuture = new C00283(this.mWorker);
    }
    ...
    public final ModernAsyncTask<Params, Progress, Result> executeOnExecutor(Executor exec, Params... params) {
        if (this.mStatus != Status.PENDING) {
            switch (C00294.$SwitchMap$android$support$v4$content$ModernAsyncTask$Status[this.mStatus.ordinal()]) {
