...
public final class dg extends di {
    ...
    private synchronized void m703c() {
        this.f724j = true;
    }

    private synchronized boolean m704d() {
        return this.f724j;
    }

    public final synchronized boolean m708a(Runnable runnable) {
        boolean z;
        if (m704d()) {
            z = false;
        } else {
    ...
    private void m706f() {
        if (!az.m375A().f387t) {
            ...
            if (!this.f718d.delaySendingAppLoad()) {
                ...
                dfVar.m700a(n, new C1056a(), this.f718d.m445e(), "/v0/appload", this.f718d.m442b(), this.f722h, new C1055b());
                dfVar.m700a(o, new C1059a(), this.f718d.m442b(), "/android_v2/handle_exceptions", null, this.f722h, new C1057a());
                dfVar.m700a(q, new C1059a(), this.f718d.m442b(), "/android_v2/handle_ndk_crashes", null, this.f722h, new C1057a());
                dfVar.m700a(r, new C1059a(), this.f718d.m442b(), "/android_v2/handle_crashes", null, this.f722h, new C1057a());
                dfVar.m700a(p, new C1059a(), this.f718d.m442b(), "/android_v2/handle_exceptions", null, new ba(this.f722h, this.f718d), new C1057a());
                dfVar.m699a();
            }
            if (y.m744b()) {
                az.m375A().m382E();
    ...
    public final void m707a() {
        ...
        if (this.f725k) {
            ...
            C1072h.m781b(this.f719e);
        } else {
            Context context2 = this.f719e;
            C1072h c1072h = new C1072h(context2);
            ...
            if (sharedPreferences.contains("interval")) {
                c1072h.f808d = sharedPreferences.getInt("interval", 10);
                if (sharedPreferences.contains("kill")) {
                    c1072h.f807c = sharedPreferences.getBoolean("kill", false);
                    if (sharedPreferences.contains("persist")) {
                        c1072h.f806b = sharedPreferences.getBoolean("persist", false);
                        if (sharedPreferences.contains("enabled")) {
                            c1072h.f805a = sharedPreferences.getBoolean("enabled", false);
                        } else {
                            c1072h = null;
                        }
                    } else {
